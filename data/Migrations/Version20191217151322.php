 ...
 */
final class Version20191217151322 extends AbstractMigration
{    
    /**
    ...
    public function up(Schema $schema) : void
    {
        ...
        $table->addForeignKeyConstraint('office', ['office_id'], ['id'], 
                ['onDelete'=>'CASCADE', 'onUpdate'=>'CASCADE'], 'contract_office_id_office_id_fk');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $table = $schema->getTable('contract');
        $table->removeForeignKey('contract_office_id_office_id_fk');
