...
final class Version20190727163602 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $table = $schema->createTable('cross_');
        ...
        $table->addColumn('producer_name', 'string', ['notnull'=>false, 'length'=>128]);
        $table->addColumn('producer_article', 'string', ['notnull'=>false, 'length'=>32]);
