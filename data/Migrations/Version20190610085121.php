...
final class Version20190610085121 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $table->addColumn('module', 'string', ['notnull' => true, 'lenght' => 128]);
        $table->addColumn('controller', 'string', ['notnull' => true, 'lenght' => 128]);
        ...
        $table->addUniqueIndex(['module', 'controller', 'action'], 'mca_uindx');
