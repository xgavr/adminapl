 ...
 */
class Currency extends \Application\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', '' . "\0" . 'Application\\Entity\\Currency' . "\0" . 'rate'];
        }
