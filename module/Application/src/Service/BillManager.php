...
//            var_dump($data); exit;
            ...
            $result[] = [
                'ИННЮЛ' => $data['Документ']['СвСчФакт']['СвПрод']['ИдСв']['СвЮЛУч']['@attributes']['ИННЮЛ'] ?? '',
                '',
            ...
            $result[] = [
                '',
                '',
                'НомерДок' => $data['Документ']['СвСчФакт']['@attributes']['НомерДок'] ?? '',
                'ДатаДок' => $data['Документ']['СвСчФакт']['@attributes']['ДатаДок'] ?? '',
                '',
                '',
                '',
                '',
            ...
            foreach ($rows as $row){
                $result[] = [
                    ...
                    'НаимЕдИзм' => $row['@attributes']['НаимЕдИзм'] ?? '',                    
                    'СтТовУчНал' => $row['@attributes']['СтТовУчНал'] ?? '',                    
                    'КодПроисх' => $row['СвДТ']['@attributes']['КодПроисх'] ?? '',                    
                    'КрНаимСтрПр' => $row['ДопСведТов']['КрНаимСтрПр'] ?? '',
                    'НомерТД' => $row['СвДТ']['@attributes']['НомерДТ'] ?? '',
                ];
            }
