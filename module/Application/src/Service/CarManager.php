...
//        var_dump(count($oems));
        ...
        foreach ($oems as $oem){
            $goodsWithCars = $this->entityManager->getRepository(Oem::class)
                    ->findGoodsWithCarsByOem($good, $oem['oe'], $categoryIds);
...
//        
        $singleUpdates = [
            // Хладагенты кондиционеров (переносим в соответствующий тип на сайте)
            'R134a' => 'Фреон R-134a',
            'R12' => 'Фреон R-12',

            // Допуски Scania для коммерческой техники
            'STO 1:0' => 'Scania STO 1:0',

            // Трансмиссионные спецификации MAN и ZF
            'MAN 342 - M1' => 'MAN 342 Typ M1',
            'MAN 342 - S1' => 'MAN 342 Typ S1',
            'MAN - 342 - S1' => 'MAN 342 Typ S1',
            'MAN - 342 - M1' => 'MAN 342 Typ M1',
            'M 3343 - S' => 'MAN 342 Typ S1', // Старый код спецификации M 3343 равен Typ S1
            '12E' => 'ZF TE-ML 12E',         // Обрезка кода трансмиссии ZF
            'ZF TE-ML 14C' => 'ZF TE-ML 14C',
            'ZF TE-ML 02C' => 'ZF TE-ML 02C',
            'ZF TE-ML 02K' => 'ZF TE-ML 02K',

            // Международные трансмиссионные стандарты API (базовые)
            'API GL-5' => 'API GL-5',
            'API GL 5' => 'API GL-5',
            'GL 5' => 'API GL-5',
            'API GL 3' => 'API GL-3',

            // Спецификации MB и Allison
            'MB 235.11' => 'MB 235.11',
            'MB 235.7' => 'MB 235.7',
            'MB 235.8' => 'MB 235.8',
            'MB 235.0' => 'MB 235.0',
            ...
            'MB 235.15' => 'MB 235.15',
            'MB 235.9' => 'MB 235.9',
            'Allison TES-295' => 'Allison TES-295',

            // Спецификации по маслу в раздатки, редукторы и роботы (VAG / BMW / Volvo)
            'Трансмиссионное масло «Вольво» 97312' => 'Volvo 97312',
            'Трансмиссионное масло «Вольво» 97315' => 'Volvo 97315',
            '33 11 7 695 240' => 'BMW OSP', // Артикул оригинального синтетического масла в редукторы заднего моста
            'G 052 911 A2' => 'VAG G 052 911',
            'G 060 175 A2' => 'VAG G 060 175', // Масло муфты Haldex 5-го поколения
            'G 052 190 A2' => 'VAG G 052 190',
            'G 055 175 A2' => 'VAG G 055 175', // Масло муфты Haldex 4-го поколения
            'G 052 175 A1' => 'VAG G 052 175', // Масло муфты Haldex ранних поколений
            'G 055 190 A2' => 'VAG G 055 190',
            'G 052 196 A2' => 'VAG G 052 196',
            'G 052 539 A2' => 'VAG G 052 539',
            'G 005 000' => 'VAG G 005 000',
            'G 002 000' => 'VAG G 002 000',
            '30759648' => 'Volvo 30759648',
            '1161 620' => 'Volvo 1161620',
            '1161 723' => 'Volvo 1161723',
            '1161 521' => 'Volvo 1161521',

            // Спец-жидкости для ГУР, роботов Селеспид и гидравлики
            'TUTELA CAR CS SPEED' => 'Fiat 9.55550-SA1', // Масло для РКПП Selespeed (Alfa Romeo/Fiat)
            'FIAT 9.55550-SA1' => 'Fiat 9.55550-SA1',
            'LDS Total H50126' => 'PSA S71 2710',        // Оранжевая гидравлика LDS Citroen
            'LHM' => 'PSA B71 2710',                      // Зеленая минеральная гидравлика LHM Plus
            'DPSF II' => 'Honda DPSF-II',                 // Масло заднего редуктора Dual Pump Fluid Honda
            '8U7J-8708687-AA' => 'Ford 8708687',         // Спец-масло муфты халдекс Ford

            // Спортивные и премиальные линейки масел (привязка к допуску)
            'Castrol SAF-XO' => 'BMW OSP',                 // SAF-XO — это масло под старый ОЕМ допуск редукторов БМВ без блокировок
            'Castrol BOT 720' => 'Land Rover LR019727',    // Масло заднего дифференциала с блокировкой (Jaguar / Land Rover)
            'Castrol EPX' => 'API GL-5 80W-90',
            'Castrol SAF Carbon Mod Plus' => 'BMW SAF-Carbon Mod', // Масло под редукторы М-серий с блокировками
            'Shell Spirax Super TS90' => 'API GL-5 90',

            // Индустриальные пластичные смазки
            'EP 00' => 'Смазка полужидкая EP 00',          // Централизованная система смазки грузовиков

            // Нормализация стандартов ATF
            'Dexron III' => 'GM Dexron III-G',
            'Dexron III G' => 'GM Dexron III-G',

            // Нормализация связок «Вязкость + Класс» к единому международному синтаксису
            'API GL4 SAE 75W-80' => 'API GL-4 75W-80',
            'API GL5 SAE 75W-80' => 'API GL-5 75W-80',
            'SAE 75W-80' => 'SAE 75W-80',
            'SAE 80 W 90 GL5' => 'API GL-5 80W-90',
            'SAE 80 W 140 GL5' => 'API GL-5 80W-140',
            'SAE 75 W 90 GL5' => 'API GL-5 75W-90',
            'SAE 75 W 140 GL5' => 'API GL-5 75W-140',
            'API GL5 SAE 85 W 140' => 'API GL-5 85W-140',
            'SAE 90 GL5' => 'API GL-5 90',
            'SAE 85 W 140 GL5' => 'API GL-5 85W-140',
            'API GL5 SAE 80W-140' => 'API GL-5 80W-140',
            'SAE 80 W 90 GL3' => 'API GL-3 80W-90',
            'API GL6 SAE 90' => 'API GL-6 90',
            'SAE 75W-140' => 'SAE 75W-140',
            'API GL5 SAE 85 W 90' => 'API GL-5 85W-90',
            'SAE 85 W 90 GL5' => 'API GL-5 85W-90',
            'SAE 90' => 'SAE 90',
            'SAE 90W' => 'SAE 90',
            'Mopar 75W-140' => 'API GL-5 75W-140',

            // Блок длинных кодов BMW
            '83 22 0 142 516' => 'BMW MTF-LT-1',
            '83 22 7 533 818' => 'BMW MTF-LT-3',
            '83 22 9 407 768' => 'BMW MTF-LT-1',
            '83 22 0 309 031' => 'BMW TF 0870',
            '83 22 7 542 290' => 'BMW MTF-LT-2',
            '83 22 9 407 807' => 'BMW MTF-LT-1',
            '83 22 9 407 870' => 'BMW MTF-LT-1',
            '83 22 0 026 922' => 'BMW MTF-LT-1',
            '83 22 2 152 426' => 'BMW MTF-LT-5',
            '000 043 205 09' => 'Porsche 00004320509',
            '81 22 9 407 305' => 'BMW 81229407305',
            '000 043 205 30' => 'Porsche 00004320530',
            '83 22 2 148 578' => 'BMW DCTF-1',
            '83 22 0 397 114' => 'BMW MTF-LT-3',
            '83 22 0 142 513' => 'BMW MTF-LT-1',
            '81 22 7 533 818' => 'BMW MTF-LT-3',
            '000 043 300 37' => 'Porsche 00004330037',
            '83 22 2 282 583' => 'BMW MTF-LT-3',
            '83 22 0 403 248' => 'BMW 83220403248',
            '81 22 9 407 758' => 'BMW 81229407758',
            '83 22 0 140 416' => 'BMW MTF-LT-1',
            '83 22 0 024 359' => 'BMW MTF-LT-1',

            // Оригинальные кроссы GM и Jaguar
            '93 165 387' => 'GM 1940182',
            '93 165 388' => 'GM 1940004',
            '93 165 382' => 'GM 1940182',
            'JLM 20255' => 'Jaguar JLM 20255',
            '90004033/1970452' => 'GM 1940712' // Исправлен сложный двойной ОЕМ-код Opel
        ];
...
//        ];
        ...
        $splitUpdates = [
            // Убираем множественные косые черты в агрегатных допусках Mercedes
            'MB 235.0/6/8/20' => ['MB 235.0', 'MB 235.6', 'MB 235.8', 'MB 235.20'],
            'MB 235.0/6/8' => ['MB 235.0', 'MB 235.6', 'MB 235.8'],
            'MB 235.1/5/11' => ['MB 235.1', 'MB 235.5', 'MB 235.11'],
            'MB 235.8/20' => ['MB 235.8', 'MB 235.20'],

            // Классические связи трансмиссионного масла с американскими требованиями Allison
            'ATF Dexron III|Allison C4' => ['GM Dexron III-G', 'Allison C4'],

            // Разбиение универсальных стандартов
            'GL4/5' => ['API GL-4', 'API GL-5'],
            'SAE 75 W 140 GL4/5' => ['API GL-4 75W-140', 'API GL-5 75W-140'],
            'API GL4/5 SAE 85 W 90' => ['API GL-4 85W-90', 'API GL-5 85W-90'],
            'API GL4/5 SAE 80 W 90' => ['API GL-4 80W-90', 'API GL-5 80W-90'],

            // Разбиение стандартных цепочек через вертикальную черту
            'MB 235.1|MB 235.5|MB 235.11' => ['MB 235.1', 'MB 235.5', 'MB 235.11'],
            'ZF TE-ML 02B|ZF TE-ML 02C' => ['ZF TE-ML 02B', 'ZF TE-ML 02C'],
            'MB 235.8|MB 235.20' => ['MB 235.8', 'MB 235.20'],
            'MB 235.0|MB 235.6|MB 235.8' => ['MB 235.0', 'MB 235.6', 'MB 235.8'],
            'MB 235.0|MB 235.7' => ['MB 235.0', 'MB 235.7'],
            'MB 236.10|MB 236.12' => ['MB 236.10', 'MB 236.12'],
