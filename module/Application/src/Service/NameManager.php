...
//                $result['attrPart'] = $this->attrPart($good);
    ...
    /**
     * Генерация наименования с помощью ИИ
     * @param Goods $good
     */
    public function aiNaming($good)
    {
        if (count($good->articleTitles())){
            $messages[] = [
                'role' => 'system',
                'content' => 'Ты опытный менеджер по продажам автозапчастей и заполняешь '
                . 'карточки товаров на сайте магазина. Ниже будут наименования одного и того же '
                . 'товара из прайсов поставщиков. Сделай из них для карточки товара '
                . 'наименование, описание, характеристики и применимость (если есть). Результат верни в формате '
                . 'JSON-массива без каких-либо пояснений, например, '
                . '{"наименование": "название товара", "описание": "описание товара", '
                . '"характеристики": {"характеристика1":"значение характеристики1", "характеристика2":"значение характеристики2"},'
                . '"применимость": [{"марка":"название марки авто1", "год_начало":"год начала применимости", "год_конец":"год окончания применимости", '
                . '"модели": [{"модель":"название модели марки авто1", '
                . '"год_начало":"год начала применимости", "год_конец":"год окончания применимости",'
                . '"модификации":[{"модификация":"название модификации модели марки авто1", '
                . '"год_начало":"год начала применимости", "год_конец":"год окончания применимости"}]}]}]'
            ];
            $messages[] = [
                'role' => 'user',
                'content' => 'Артикул: '.$good->getCode().PHP_EOL.
                ' Производитель:'.$good->getProducer()->getName().PHP_EOL.
