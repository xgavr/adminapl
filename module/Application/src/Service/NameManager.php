    ...
    public function aiNaming($good)
    {
        if (count($good->articleTitles())){
            $messages[] = [
                ...
                . 'Тип товара + Производитель + Артикул + Применимость (если есть) + Особенности (объем/кол-во/цвет/сезонность/марка авто и пр), '
                . '2. Подробное описание (до 900 знаков). Результат верни в формате '
