    ...
    public function aiNaming($good)
    {
        if (count($good->articleTitles())){
            $messages[] = [
                ...
                . 'наименование (Наименование + Производитель + Артикул)(не более 90 знаков), '
                . 'описание, характеристики и применимость (если есть). Результат верни в формате '
                . 'JSON без каких-либо пояснений, например, '
                . '{"name": "название товара", "description": "описание товара", '
                . '"features": [{"name":"название характеристики1", "value":"значение характеристики1"}],'
                . '"applicability": [{"name":"название бренда авто1", "begin":"год начала применимости", "end":"год окончания применимости", '
                . '"models": [{"name":"название модели бренда авто1", '
                . '"begin":"год начала применимости", "end":"год окончания применимости",'
                . '"cars":[{"name":"название модификации модели бренда авто1", '
                . '"begin":"год начала применимости", "end":"год окончания применимости"}]}]}]'
            ];
            $messages[] = [
                'role' => 'user',
