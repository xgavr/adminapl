...
//        var_dump($queryBuilder->getQuery()->getSQL()); exit;
    ...
    public function findAllProducer($params = null)
    {
        ...
        $queryBuilder->select('p.id, p.aplId, p.name, p.goodCount, count(up.id) as unknownProducerCount, sum(up.supplierCount) as supplierCount, sum(up.rawpriceCount) as rawpriceCount')
