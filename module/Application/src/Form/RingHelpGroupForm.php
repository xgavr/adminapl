...
/**
 * Description of RingHelpGroupForm
 *
 * @author Daddy
 */
class RingHelpGroupForm extends Form
{    
    ...
    */
    protected function addElements() 
    {
        ...
        $this->add([            
            ...
            'options' => [
                'label' => 'Статус',
                'value_options' => RingHelpGroup::getStatusList(),
                'value' => RingHelpGroup::STATUS_ACTIVE,
            ],
        ]);
   ...
   /**
    ...
    private function addInputFilter() 
    {
        ...
        $inputFilter->add([
                ...
                'validators' => [
                    ['name'=>'InArray', 'options'=>['haystack'=> array_keys(RingHelpGroup::getStatusList())]]
                ],
            ]); 
