...
class CarFillType {
    ...
    /**
    * @ORM\OneToMany(targetEntity="\Application\Entity\CarFillVolume", mappedBy="carFillType")
    * @ORM\JoinColumn(name="id", referencedColumnName="car_fill_type_id")
     */
