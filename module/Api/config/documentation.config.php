...
- данные о поступлениях"
    ...
    'Api\\V1\\Rest\\ApiLanding\\Controller' => [
        'collection' => [
            'POST' => [
                'request' => 'Все поля не обязательны, кроме телефона. В goods - все поля обязательны
{
   "name": "Имя покупателя",
   "phone": "Телефон",
   "need": "Что нужно?",
   "address": "Самовывоз или куда доставить",
   "email": "Электропочта",
   "geo": "ip покупателя",
   "office": "Офис самовывоза",
   "vin": "VIN номер",
   "mode": "Вид заказа (6 - лендинг, 7 - предложение)",
   "user": "Ид менеджера (в админапл)(Night - 21)"
   "goods": "Товары" массив,
   "goods[id]": "Ид товара в админапл",
   "goods[num]": "Количество",
   "goods[price]": "Цена",
}',
            ],
        ],
