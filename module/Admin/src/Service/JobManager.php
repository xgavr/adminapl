...
class JobManager 
{
    ...
    private function aplExJobList()
    {
        return [
          ...
          317 => ['command' => 'update-good-names',             'shedule' => '46 * * * *',              'description' => 'Обновление наименований товаров в Апл'],
          318 => ['command' => 'update-good-prices',            'shedule' => '31,46 * * * *',           'description' => 'Обновление цен товаров в Апл'],
          319 => ['command' => 'update-rawprices',              'shedule' => '01,16,31 * * * *',        'description' => 'Обновление строк прайсов в АПЛ'],
