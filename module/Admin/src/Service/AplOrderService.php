...
//            var_dump($result); exit;
            ...
            $this->orderManager->addOrderPhoneEmail($order, [
                'phone' => empty($result['phone']) ? '0000000000':$result['phone'],
...
//                    var_dump($response->getBody()); exit;                    
    ...
    public function markDublicate()
    {
        ...
        $aplDublicate = Decoder::decode(file_get_contents('https://old.autopartslist.ru/orders/dublicate-bags'), \Laminas\Json\Json::TYPE_ARRAY);
