...
//                }
    ...
    public function findAcquiring($params = null)
    {
        ...
        $queryBuilder->select('a.id, a.transDate, a.operDate, a.point, a.cartType, a.acode, a.rrn, a.output, a.status, p.aplPaymentType, p.aplPaymentTypeId, p.aplPaymentDate, p.aplPaymentSum')
