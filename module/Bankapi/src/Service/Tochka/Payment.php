...
//        var_dump($request_id); exit; 
     ...
     * @param array $data_payment Описание полей:
            ...
            "payerKPP": "500101001", КПП за кого платят Заполняется только за 3 лицо при платеже в бюджет. Если платите за себя в бюджет на единый налоговый счёт (ЕНС), укажите "0"
